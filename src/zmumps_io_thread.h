...
/*    $Id: zmumps_io_thread.h,v 1.21 2006/03/27 16:46:59 jylexcel Exp $  */
#ifndef _WIN32  
...
int   zmumps_async_write_th(const int * strat_IO,void * address_block,int * block_size,int * pos_in_file,
