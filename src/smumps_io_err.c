...
*/
/*    $Id: smumps_io_err.c,v 1.7 2006/06/15 15:06:24 jylexcel Exp $  */
...
int smumps_io_prop_err_info(int ierr){
  ...
  *dim_mumps_err=strlen(smumps_err);
  return 0;
}
...
void smumps_low_level_init_err_str(int * dim, char* err_str, smumps_ftnlen l1){
