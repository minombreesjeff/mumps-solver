...
*/
/*    $Id: smumps_io_basic.h,v 1.46 2006/06/05 14:54:49 aguermou Exp $  */
...
#ifndef _WIN32
#define SMUMPS_IO_FLAG_TRY_O_DIRECT O_RDWR
#endif
...
int smumps_io_write__(void *file, void *loc_add, size_t write_size, int where);

#ifndef _WIN32
int smumps_io_write_os_buff__(void *file, void *loc_add, size_t write_size, int where);
int smumps_io_write_direct_io__(void *file, void *loc_addr, size_t write_size, int where);
int smumps_io_flush_write__();
#else
int smumps_io_write_win32__(void *file, void *loc_add, size_t write_size, int where);
#endif
...
int smumps_io_read_direct_io__(void * file,void * loc_addr,size_t size,int local_offset);
#else
