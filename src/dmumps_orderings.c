...
*/
/* $Id: dmumps_orderings.c,v 1.21 2006/03/27 16:46:59 jylexcel Exp $ */
/*
...
FORTRAN (
 DMUMPS_PORDF_WND, dmumps_pordf_wnd, (
int *nvtx, \
int *nedges,\
int *xadj, \
int *adjncy,\
...
{
*ncmpa = dmumps_pord_wnd (*nvtx, *nedges, xadj, adjncy, nv,totw);
}
